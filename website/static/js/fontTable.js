module.exports = function(code) {
  ...
  var fontTableHeader =
    ...
    fontRows[0]
      ...
      .split("-")
      .join(" ") +
    ' <strong style="color: white; background-color: gray; padding: 8px; border-radius: 90px;">WEB</strong></h3>';
  for (font in fontRows) {
    ...
    var newRow =
      ...
      '<div class="largeFormFont" style="font-family:\'' +
      fontName +
      "';font-style:" +
      fontStyle +
      ";font-weight:" +
      ...
      "Aa" +
      "</div>" +
      '<div class="alphabetDisplay" style="font-family:\'' +
      fontName +
      "';font-style:" +
      fontStyle +
      ";font-weight:" +
      ...
      "</div>" +
      '<div class="fontInfo">' +
      '<span style="border-bottom:2px solid black;margin-bottom:5px;">' +
      fontName +
      "</span>" +
      "<br>" +
      "Weight: <span style=\"font-family:'" +
      fontName +
      "';font-style:" +
      fontStyle +
      ";font-weight:" +
